      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap:14, marginBottom:28 }}>
        {quickLinks.map(l => (
          <Link key={l.href} href={l.href} style={{ textDecoration:'none' }}>
            <div style={{ background:l.highlight ? 'linear-gradient(135deg,#2D3278,#1a1f5e)' : '#fff', borderRadius:14, padding:'18px 20px', border:l.highlight ? 'none' : '1px solid #e2e8f4', cursor:'pointer', display:'flex', alignItems:'center', gap:14 }}>
