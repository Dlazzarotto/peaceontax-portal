...
export default function NewPasswordPage() {
  ...
  return (
    <div style={s}>
      <div style={card}>
        <h1 style={{ fontFamily: 'Georgia,serif', fontSize: 20, color: '#0f2340', marginBottom: 16 }}>🔒 New Password</h1>
        {done ? <p style={{ color: '#1a6b4a' }}>Password updated! Redirecting…</p> : (
          <>
            <input type="password" value={pass} onChange={e => setPass(e.target.value)} placeholder="New password (min 8 chars)"
            ...
            <button onClick={update} disabled={pass.length < 8}
