// Document categories for Individual and Business clients
// Structure: year > category > subcategory
...
export const INDIVIDUAL_CATEGORIES = {
  ...
  'Signed Documents': [
    'Engagement Letter',
    'Federal Return (Signed)',
    'State Return (Signed)',
    '8879 E-File Authorization',
  ],
}
...
export const BUSINESS_CATEGORIES = {
  ...
  'Tax Documents': [
    '1120 / 1120S / 1065 Return',
    'Schedule K-1s Issued',
    'Sales Tax Returns',
    'Property Tax',
...
export function getCategories(clientType: 'individual' | 'business') {
