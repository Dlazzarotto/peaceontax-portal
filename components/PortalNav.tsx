  ...
  return (
    <nav style={{ background:'linear-gradient(135deg,#2D3278,#1a1f5e)', color:'#fff', padding:'0 24px', height:56, display:'flex', alignItems:'center', gap:4, position:'sticky', top:0, zIndex:100, boxShadow:'0 2px 16px rgba(45,50,120,0.4)' }}>
      <div style={{ display:'flex', alignItems:'center', gap:10, marginRight:16, flexShrink:0 }}>
        <div style={{ width:32, height:32, borderRadius:8, background:'linear-gradient(135deg,#F47B20,#e06010)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:16 }}>📒</div>
        <div>
          <div style={{ fontFamily:'Georgia,serif', fontWeight:800, fontSize:15, color:'#fff', lineHeight:1 }}>Peace on Tax</div>
          <div style={{ fontSize:10, color:'rgba(255,255,255,0.45)', marginTop:1 }}>{clientType==='business'?'🏢 Business':'👤 Individual'}</div>
        </div>
      </div>
